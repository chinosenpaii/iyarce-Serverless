...
module.exports = async function (context, req) {
    ...
    let download = ""
    let downloadpng = "https://blobstorageandme.blob.core.windows.net/images/" + username + ".png";
    let downloadjpg = "https://blobstorageandme.blob.core.windows.net/images/" + username + ".jpeg";
